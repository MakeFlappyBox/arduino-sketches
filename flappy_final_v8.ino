#include <Servo.h> 
#include "pitches.h"
const int magnetPin = 6;     // the number of the reed switch
const int buttonPin = 3;  // the number of the pushbutton pin for bird
const int startPin = 2;  // the number of the start button pin to start
...
{ 
  ...
  myservoBird.attach(7);
  myservoRoll.attach(9);
  myservoGame.attach(10);
  myservoGame.write(0); 
